...
class myService1VC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = serviceTable.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! myservicesCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            if let selectedPhone = sender as? ShopSearch,
                let destinationVC = segue.destination as? UINavigationController {
                  if let childVc = destinationVC.topViewController as? detailedmyService1VC {
