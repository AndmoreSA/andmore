...
class detailedCancelledVC: UITableViewController, UICollectionViewDelegate, UICollectionViewDataSource, MFMailComposeViewControllerDelegate {
       ...
       @IBOutlet weak var justify: UILabel!
    ...
    // MARK:- Variables
         ...
         func retrieve() {
            ...
            if let justif = selectedShop?.justification {
                justify.text = justif
            } else {
                justify.isHidden = true
            }
            ...
            func retreiveUserChosenTime() {
                Database.database().reference().child("VenueAppointments").child("cancel").child(venueID).child(bookedID).child("times").observeSingleEvent(of: .value) { (snapshot) in
                     print(snapshot)
                  ...
                  func numberOfSections(in collectionView: UICollectionView) -> Int {
                     ...
                     func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
                             let cell = reservationTimeCollectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! timeCancellCell
