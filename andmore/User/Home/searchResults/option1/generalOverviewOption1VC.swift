//
//  generalOverviewOption1VC.swift
//  andmore
//
...
class generalOverviewOption1VC: UITableViewController,UICollectionViewDelegate, UICollectionViewDataSource,  MKMapViewDelegate , CLLocationManagerDelegate {
...
func welcoming() {
    ...
    Database.database().reference().child("All").child(uid).observeSingleEvent(of: .value) { (snapshot) in
        ...
        self.skills = dict?["skills"] as? String ?? ""
    }
}
         ...
         func numberOfSections(in collectionView: UICollectionView) -> Int {
            ...
            func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
                ...
                if collectionView == imageSliderView {
                    let cell = imageSliderView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! SliderOption1Cell
                    ...
                    let cell2 = availablilityCollectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! availabilityOverview1Cell
    ...
    if Reachability.isConnectedToNetwork(){
        ...
        userDefaults.set(currency, forKey: "currency")
            ...
            for i in 0..<arrSelectedData.count {
              ...
              performSegue(withIdentifier: "toSummary", sender: selectedShop)
     ...
     override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
         if segue.identifier == "toSummary" {
             if let selectedPhone = sender as? venueSearch,
                 let destinationVC = segue.destination as? bookingSummaryOption1VC {
