...
class searchResultOption2VC: UIViewController, UITableViewDelegate, UITableViewDataSource , CLLocationManagerDelegate , locationDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    override func viewDidLoad() {
        ...
        Timer.scheduledTimer(timeInterval: 10, target: self, selector: #selector(searchResultOption2VC.enableButton), userInfo: nil, repeats: false)
...
//                        self.createAlert(title: "No Store Available", message: "Sorry, Please try different date ")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = searchResultTableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as! searchResultsoption2Cell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let childVc = destinationVC.topViewController as? generalOverviewOption2VC {
