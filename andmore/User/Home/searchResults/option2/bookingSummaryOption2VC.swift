...
class bookingSummaryOption2VC: UITableViewController, UICollectionViewDelegate , UICollectionViewDataSource{
...
//                                        timeSlot.slot = each.value as! Int
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = chosenTimeCollectionView.dequeueReusableCell(withReuseIdentifier: "Cell", for: indexPath) as! chosenTimeSummary2Cell
